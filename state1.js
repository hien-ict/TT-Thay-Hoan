...
demo.state1.prototype = {
  preload: function(){
    ...
    game.load.image('grassTiles', 'PhaserDemo-master/assets/tilemaps/grassTiles.png');
    game.load.image('rockTiles', 'PhaserDemo-master/assets/tilemaps/rockTiles.png');
    game.load.image('adam', 'PhaserDemo-master/assets/sprites/adam.png');
  },
  create: function(){
